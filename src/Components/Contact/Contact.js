          ...
          <div className="row Contactcontent__Row">
            <div className="col-6">
              <div class="form-group ">
                ...
                <input type="name" name="name" id="Forname" class="form-control" placeholder="ie.John doe" value={name} onChange={(e) => setname(e.target.value)}></input>
              </div>
            </div>
          </div>
          <div className="row Contactcontent__Row">
            <div className="col-6">
              ...
              <label for="email">Your Email</label>
                <input type="email" name="email" id="email" class="form-control" placeholder="johndoe@gmail.com" value={email} onChange={(e) => setemail(e.target.value)}></input>
              </div>
            </div>
          </div>
          <div className="row Contactcontent__Row">
